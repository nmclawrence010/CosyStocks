...
const Navbar = () => {
  ...
  return (
    <div className="relative">
      <div className="relative z-50 transition-colors duration-200">
        <div className="relative overflow-hidden">
          <div className="absolute left-0 top-0 bottom-0 w-10 bg-[#FAE7DD] dark:bg-background-dark z-10 transition-colors duration-200"></div>
          <div className="absolute right-0 top-0 bottom-0 w-10 bg-[#FAE7DD] dark:bg-background-dark z-10 transition-colors duration-200"></div>
